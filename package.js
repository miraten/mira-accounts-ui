Package.describe({
  summary: "Accounts-ui widgets using Bootstrap 3.x"
});

Package.on_use(function (api) {
  api.use(['deps', 'service-configuration', 'accounts-base',
           'underscore', 'templating', 'session', 'mira-i18n'], 'client');
...
Package.on_test(function (api) {
  api.use('mira-accounts-ui');
  api.use('tinytest');
  api.add_files('test/accounts_ui_tests.js', 'client');
});
