...
Template._loginButtonsLoggedInDropdown.events({
  ...
  'click #login-button-close': function (e) {  
    e.stopPropagation();
...
Template._loginButtonsLoggedOutPasswordService.fields = function () {
  var loginFields = [
    {fieldName: 'username-or-email', fieldLabel: I18n.get('accounts.label_username_or_email'),
     visible: function () {
       return _.contains(
         ["USERNAME_AND_EMAIL", "USERNAME_AND_OPTIONAL_EMAIL"],
         passwordSignupFields());
     }},
    {fieldName: 'username', fieldLabel: I18n.get('accounts.label_username'),
     visible: function () {
       return passwordSignupFields() === "USERNAME_ONLY";
     }},
    {fieldName: 'email', fieldLabel: I18n.get('accounts.label_email'), inputType: 'email',
     visible: function () {
       return passwordSignupFields() === "EMAIL_ONLY";
     }},
    {fieldName: 'password', fieldLabel: I18n.get('accounts.label_password'), inputType: 'password',
     visible: function () {
       return true;
     }}
  ];
  ...
  var signupFields = [
    ...
    {fieldName: 'email', fieldLabel: I18n.get('accounts.label_email_option'), inputType: 'email',
     visible: function () {
    ...
    {fieldName: 'password-again', fieldLabel: I18n.get('accounts.label_password_again'),
     inputType: 'password',
     visible: function () {
...
Template._loginButtonsChangePassword.fields = function () {
  return [
    {fieldName: 'old-password', fieldLabel: I18n.get('accounts.label_current_password'), inputType: 'password',
     visible: function () {
       return true;
     }},
    {fieldName: 'password', fieldLabel: I18n.get('accounts.label_new_password'), inputType: 'password',
     visible: function () {
       return true;
     }},
    {fieldName: 'password-again', fieldLabel: I18n.get('accounts.label_new_password_again'),
     inputType: 'password',
     visible: function () {
       // No need to make users double-enter their password if
       // they'll necessarily have an email set, since they can use
